    ...
    if ($aksi === 'tambah') {
        ...
        try {
            ...
            if ((int)$e->getCode() === 23000) {
                $error = 'Petugas ini tidak bisa dihapus karena masih memiliki riwayat transaksi yang tercatat. Nonaktifkan saja akunnya kalau ingin membatasi akses.';
            } else {
                $error = 'Terjadi kesalahan saat menghapus data petugas.';
            }
        }
    }
}
