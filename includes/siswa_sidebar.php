<?php
/**
 * Sidebar untuk seluruh halaman Siswa.
 * Include file ini setelah requireSiswa() dipanggil.
 * Set $activeMenu sebelum include untuk menandai menu aktif, contoh:
 *   $activeMenu = 'dashboard';
 */
$activeMenu = $activeMenu ?? '';

function siswaSideLink($href, $key, $label, $svgInner, $active) {
...
<aside class="admin-sidebar">
  <div class="admin-sidebar-brand">
    ...
    <div><strong>Perpustakaan</strong><small>Panel Siswa</small></div>
  </div>
  <nav class="admin-side-nav" aria-label="Navigasi siswa">
    <div class="admin-side-label">MENU UTAMA</div>
    <?php siswaSideLink('dashboard.php', 'dashboard', 'Dashboard', '<rect x="3.5" y="3.5" width="7" height="8" rx="1.5"/><rect x="13.5" y="3.5" width="7" height="5" rx="1.5"/><rect x="13.5" y="11.5" width="7" height="9" rx="1.5"/><rect x="3.5" y="14.5" width="7" height="6" rx="1.5"/>', $activeMenu); ?>

    <div class="admin-side-label" style="margin-top:14px;">OPERASIONAL</div>
    <?php siswaSideLink('pinjam.php', 'pinjam', 'Peminjaman Buku', '<path d="M4 5.5c2.2-1 5-1 7 .3v13.7c-2-1.3-4.8-1.3-7-.3V5.5Z"/><path d="M20 5.5c-2.2-1-5-1-7 .3v13.7c2-1.3 4.8-1.3 7-.3V5.5Z"/>', $activeMenu); ?>
    <?php siswaSideLink('kembali.php', 'kembali', 'Pengembalian Buku', '<path d="M20 7.5H6.5L9 4.5"/><path d="M4 16.5h13.5L15 19.5"/>', $activeMenu); ?>
    <?php siswaSideLink('presensi.php', 'presensi', 'Presensi Kunjungan', '<path d="M9 11.5 11.5 14 16 8.5"/><circle cx="12" cy="12" r="9"/>', $activeMenu); ?>
  </nav>
  <div class="admin-sidebar-bottom">
    <div class="admin-side-user"><span class="admin-avatar">S</span><span><strong><?= htmlspecialchars($_SESSION['anggota_nama'] ?? 'Siswa') ?></strong><small>Anggota Perpustakaan</small></span></div>
