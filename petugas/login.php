...
<main class="login-card">
  ...
  <div class="login-heading">
    <h1>Login Petugas</h1>
    <p>Masuk menggunakan akun petugas untuk mengelola aktivitas perpustakaan.</p>
  </div>
  ...
  <form method="POST" id="petugasLoginForm">
    <?= csrfField() ?>
  ...
  <div class="login-footer">
    Halaman khusus petugas perpustakaan.
  </div>
...
document.getElementById('petugasLoginForm').addEventListener('submit', function(){
