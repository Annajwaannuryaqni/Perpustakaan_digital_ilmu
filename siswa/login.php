...
<title>Login Siswa — Perpustakaan Digital</title>
...
<main class="login-card">
  ...
  <div class="login-heading">
    <h1>Login Siswa</h1>
    <p>Masuk menggunakan akun anggota untuk mengakses perpustakaan.</p>
  </div>
  ...
  <a href="daftar.php" class="register-link">
  ...
  <div class="login-footer">
    Akses untuk anggota perpustakaan sekolah.
  </div>
